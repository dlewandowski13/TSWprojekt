...
{ 
    ...
    { 
        ...
        if(gracze[i] != 1 && gracze[i].aktywnosc == true) gracze[i].rysuj(); 
    } 
} 
...
{ 
    ...
    context.fillText(imie+ ' przegral !', waz.waz[0].x*20+10  , waz.waz[0].y*20+40); 
} 
    ...
    {            
        ...
        {            
            ...
            if (i === 0) { 
                ...
                if (this.waz[0].x < 0 || this.waz[0].y <= 1) 
                { 
